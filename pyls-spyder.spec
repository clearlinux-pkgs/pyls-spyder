...
Source0  : https://files.pythonhosted.org/packages/ed/95/9ebf8f8e8e5efb32ceb3275b080fd3488a19ff07e35e4b97f621dfacdfa6/pyls-spyder-0.3.2.tar.gz
...
%prep
%setup -q -n pyls-spyder-0.3.2
cd %{_builddir}/pyls-spyder-0.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613492146
...
cp %{_builddir}/pyls-spyder-0.3.2/LICENSE %{buildroot}/usr/share/package-licenses/pyls-spyder/3b8430679131d39161725b9b41dd652aeb125d39
